...
*/
const char *AP   = "Project Owl Test";
//const char *AP   = "Project Owl Test";
...
void setup()
{
  ...
  Serial.println("TestDuck Online");
  u8x8.drawString(0, 1, "TestDuck Online");
}
...
void sendVictimPayload(Data victim)
{
  LoRa.beginPacket();
